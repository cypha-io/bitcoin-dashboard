  ...
  return (
    <div className="Sidebar">
      ...
      <List style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <ListItem button component={NavLink} to="/btc" style={{ justifyContent: 'center', width: '100%' }}>
          <ListItemIcon style={{ minWidth: 'auto' }}>
        ...
        <ListItem button component={NavLink} to="/manage-payment-apis" style={{ justifyContent: 'center', width: '100%' }}>
          <ListItemIcon style={{ minWidth: 'auto' }}>
